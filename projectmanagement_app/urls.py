...
urlpatterns = [
    ...
    path("project/<int:project_id>/tasks/", views.TaskListView.as_view(), name="task-list"),
    path("project/<int:project_id>/tasks/<int:pk>/", views.TaskDetailView.as_view(), name="task-detail"),
    path("project/<int:pk>/projectdetails/", views.ProjectDetailView.as_view(), name="project-detail"),
    ...
    path("managers/<int:manager_id>/", views.managers_projects, name="managers-projects"),
